        ...
        <React.Fragment>
            <section className="contact-search p-3">
                <div className="containetr">
                    ...
                    <Link to={`/contracts/add`} className="btn btn-primary ms-2">
